...
export default function SymptomChecker() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Header */}
      <header className="bg-blue-600 px-6 py-4 flex items-center">
        <Link
          href="/home"
      ...
      <main className="p-8 flex gap-8">
        ...
        <div className="w-2/3 flex flex-col gap-4">
          ...
          <textarea
            ...
            placeholder="Type or record your symptoms here..."
            className="w-full h-40 p-4 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ></textarea>

          <button
            onClick={handleSubmit}
            className="self-start bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700"
          >
            🩺 Analyse Symptoms
          </button>
        </div>
